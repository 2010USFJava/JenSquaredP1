...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public List<Employee> getAllEmployees() throws SQLException {
		...
		while (rs.next()) {
			e = new Employee(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
					rs.getString(6), rs.getString(7), rs.getDouble(8), rs.getDouble(9), rs.getDouble(10), rs.getInt(11),
					rs.getInt(12), rs.getInt(13), rs.getBoolean(14), rs.getBoolean(15), rs.getBoolean(16));
			elist.add(e);
		}
	...
	public Employee updateReimbursement(Employee e) throws SQLException {
		...
		String sql = "update employee set \"awarded_reimbursement\"=?, \"pending_reimbursement\"=?, \"available_reimbursement\"=? where \"eid\"=?";
		PreparedStatement ps = conn.prepareStatement(sql);
